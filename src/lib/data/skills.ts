...
export const skills: Skill[] = [
  ...
  { name: "MongoDB", icon: "🍃", proficiency: 82, years: 3, category: "backend" },
  ...
  { name: "Rust", icon: "🦀", proficiency: 45, years: 1, category: "languages", currentlyLearning: true },
  { name: "Go", icon: "🐹", proficiency: 55, years: 1, category: "languages", currentlyLearning: true },
